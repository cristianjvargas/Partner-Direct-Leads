---
name: market-landing
description: "Analyze a landing page for conversion rate optimization - headline, offer clarity, call to action, friction, social proof, mobile experience - producing LANDING-PAGE-ANALYSIS.md. Use for 'review my landing page', 'why is nobody converting', or before publishing a new page."
---
