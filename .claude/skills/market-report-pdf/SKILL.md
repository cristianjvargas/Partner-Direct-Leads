...
description: "Produce a designed multi-page PDF marketing report via scripts/generate_pdf_report.py. Use for 'give me a PDF marketing report' or when findings need to be shared outside the terminal. Requires reportlab."
---
