---
name: sales-icp
description: "Build an Ideal Customer Profile from a description of the business - firmographics, trigger events, disqualifiers, scoring weights and where to find these buyers - producing IDEAL-CUSTOMER-PROFILE.md. Use for 'who should we target', 'define our ICP', or before starting any outbound campaign."
---
