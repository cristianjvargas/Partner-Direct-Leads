...
description: "Produce a designed multi-page PDF sales pipeline report with score gauges, charts and prospect cards via scripts/generate_pdf_report.py. Use for 'give me a PDF report' or when the pipeline summary needs to be shared outside the terminal. Requires reportlab."
---
