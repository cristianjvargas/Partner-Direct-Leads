...
description: "Generate a proposal for marketing services with scope, deliverables, pricing and timeline, producing MARKETING-PROPOSAL.md. Use when pitching marketing work to a client. For a general sales proposal, use sales-proposal instead."
---
