---
name: sales-prospect
description: "Run a full prospect audit on a company URL using five parallel research agents (company fit, decision makers, BANT opportunity, competitive position, outreach readiness) and produce a scored PROSPECT-ANALYSIS.md with a ready-to-send first email. Use for 'analyze this prospect', 'should we go after this company', or a full account workup."
---
