---
name: sales-outreach
description: "Write a personalized multi-touch cold outreach sequence (email, LinkedIn, phone) grounded in real research about the prospect, producing OUTREACH-SEQUENCE.md. Use for 'write a cold email', 'build an outreach sequence', or 'draft a first touch'."
---
